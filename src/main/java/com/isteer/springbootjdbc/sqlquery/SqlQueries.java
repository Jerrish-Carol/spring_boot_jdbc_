...
public class SqlQueries {
	...
	public static final String INSERT_ROLES_QUERY="INSERT INTO tbl_roles(role, hierarchical_level, project, billable) VALUES (? ,? ,?, ?)";
	...
	public static final String UPDATE_ROLES_BY_ID_QUERY="UPDATE tbl_roles SET role=?, hierarchical_level=?, project=?, billable=? WHERE role_id=?";
